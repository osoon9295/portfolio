...
## 주요 섹션 & 기능
### Intro
- 스크롤 스냅이 적용된 첫 화면에서 간단한 인사와 핵심 메시지를 전달합니다.【F:src/app/page.tsx†L12-L19】【F:src/components/Intro.tsx†L10-L37】

### About
- 프로필 이미지 위에 "더 알아보기" 오버레이를 클릭하면 학력·교육·인턴 정보가 펼쳐집니다.【F:src/components/about/ProfileImage.tsx†L6-L36】
- 키워드와 자기소개 문단을 통해 가치관과 협업 스타일을 소개합니다.【F:src/components/about/Keyword.tsx†L1-L14】【F:src/components/about/AboutText.tsx†L1-L25】

### Skills
- 카테고리 버튼을 통해 기술 스택을 필터링하며 확인할 수 있습니다.【F:src/components/about/Skills.tsx†L1-L55】
- 기술 목록은 `constants/skills.ts`에서 관리하여 확장과 유지보수가 용이합니다.【F:src/constants/skills.ts†L1-L45】

### Projects
- 썸네일, 기간, 역할, 활용 기술을 한눈에 보여주는 카드 뷰로 주요 프로젝트를 소개합니다.【F:src/components/project/ProjectArea.tsx†L1-L21】【F:src/components/project/Project.tsx†L1-L46】
- 프로젝트 데이터는 `constants/projects.ts`로 분리되어 있어 쉽게 추가/수정할 수 있습니다.【F:src/constants/projects.ts†L12-L52】

### Contact
- Github, Velog, 이메일로 바로 연결되는 링크를 제공합니다.【F:src/components/contact/Links.tsx†L1-L20】
- "연락하기" 플로팅 버튼과 섹션 네비게이션으로 어느 위치에서도 빠르게 이동할 수 있습니다.【F:src/components/common/FAB.tsx†L1-L39】【F:src/components/common/Navigation.tsx†L1-L76】
...
※ 프로젝트에서 사용하지 않은 아이콘은 기본 대체 아이콘으로 표현됩니다.【F:src/components/project/Project.tsx†L28-L44】
