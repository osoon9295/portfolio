...
const Card = () => {
  return (
    <div className="fixed bottom-5 right-5 w-[180px] h-[200px] flex flex-col items-center justify-center gap-5 bg-lime-100 shadow-xl rounded-2xl">
      <div className="w-[110px] rounded-2xl overflow-hidden">
        <Image width={200} height={200} alt="아바타이미지" src="/image.png" />
      </div>
      <div className="flex flex-row gap-4 text-2xl items-center text-lime-800">
